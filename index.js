...
function ReadManifest() {
  return fsPromises.readFile('./package.json', 'utf8').then((data) => {
    ...
    let manifest = {
      ...
      "name": "AnimeFLV, AnimeAV1, Henaojara, TioAnime & LACartoons",
      ...
      "catalogs": [
        ...
        {
          id: "lacartoons", type: "LACartoons", name: "search results",
          extra: [{ name: "search", isRequired: true }]
        },
        {
          id: "lacartoons|all", type: "LACartoons", name: "LACartoons"
        },
        {
...
app.listen(process.env.PORT || 3000, () => {
  ...
  let imports = [animeFLVAPI, animeAV1API, tioanimeAPI, henaojaraAPI, lacartoonsAPI]
  imports.forEach((api) => {
